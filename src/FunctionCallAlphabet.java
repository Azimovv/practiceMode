...
public class FunctionCallAlphabet
{
    public static void main( String[] args )
    {
        ...
        i(4);    // pass it any integer and it will display a word beginning with I
        ...
        n("Norse");    // displays the word you pass it beginning with "N"
        ...
        t("Traitor");    // displays the word you pass it beginning with "T"
